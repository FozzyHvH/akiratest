	...
	do
		...
		function Library:Window(Options)
			local Window = {
				...
				Name = (Options.Name or Options.name or "i have a hairy ass");
			};
			--
...
do
    ...
    do -- aimbot tab
        ...
        aimbotsection:Toggle({Name = "Prediction", Flag = "prediction"})
        aimbotsection:Slider({Name = "Prediction X", Flag = "predx", Min = 0, Max = 1, Default = 0, Decimals = 0.0001})  
        aimbotsection:Slider({Name = "Prediction Y", Flag = "predy", Min = 0, Max = 1, Default = 0, Decimals = 0.0001})
		aimbotsection:Toggle({Name = "Frame Skip", Flag = "frameskip"}) 
