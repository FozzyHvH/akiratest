...
local Window = Library:Window({Name = "vanity.club", Amount = 6})

do
    local Watermark = Library:Watermark({Name = "vanity.club | $developer$ | nigger"})
    local flags = Library.Flags
    local Pages = {
        ["Aimbot"] = Window:Page({Name = "Aimbot", Weapons = true});
        ["Visuals"] = Window:Page({Name = "Visuals", Weapons = true});
		["Misc"] = Window:Page({Name = "Misc"});
        ["Players"] = Window:Page({Name = "Player List"});
        ["Settings"] = Window:Page({Name = "Settings"});
        ["Lua"] = Window:Page({Name = "Lua"})
    }

    do -- aimbot
        local subpage1 = Pages["Aimbot"]:Weapon({Icon = "rbxassetid://6034509987"})
        local subpage2 = Pages["Aimbot"]:Weapon({Icon = "rbxassetid://17134553802"})
        local subpage3 = Pages["Aimbot"]:Weapon({Icon = "rbxassetid://16997954488"})

        local sec = subpage1:Section({Name = "Aimbot"})
        local sec2 = subpage1:Section({Name = "FOV", Side = "Right"})
        sec:Toggle({Name = "Enabled", Flag = "enabled"}):Keybind({Flag = "aimbotbind"})
        sec:Toggle({Name = "Sticky Aim", Flag = "aimbot_sticky"})
        sec:List({Name = "Method", Flag = "method", Options = {"Camera", "Mouse"}, Default = "Mouse"})
        sec:Toggle({Name = "Prediction", Flag = "prediction"})
        sec:Slider({Name = "Prediction X", Flag = "predx", Min = 0, Max = 1, Default = 0, Decimals = 0.0001})  
        sec:Slider({Name = "Prediction Y", Flag = "predy", Min = 0, Max = 1, Default = 0, Decimals = 0.0001})
        sec:List({Name = "Hitpart", Flag = "hitpart", Options = {"Head", "HumanoidRootPart"}, Default = "Head"})
        sec:Slider({Name = "Smoothness", Flag = "smooth", Min = -1, Max = 1, Default = 0, Decimals = 0.01})
        sec:List({Name = "Target", Flag = "target", Options = {"Player", "Dummy"}})
    
        sec2:Toggle({Name = "Show FOV", Flag = "aimbot_showfov"})
        sec2:Toggle({Name = "FOV Enabled", Flag = "aimbot_fovenabled"})
        sec2:Slider({Name = "FOV", Flag = "aimbot_fov", Min = 0, Max = 800, Default = 100})
        sec2:Colorpicker({Name = "FOV Color", Flag = "aimbot_fovcolor", Default = Color3.fromRGB(255, 255, 255)})

        -- silent
        local silentsec = subpage2:Section({Name = "Silent Aim"})
        local silentsec2 = subpage2:Section({Name = "FOV", Side = "Right"})
        local silentsec3 = subpage2:Section({Name = "Exploits", Side = "Right"})
        silentsec:Toggle({Name = "Silent Aim", Flag = "silentaim_enabled"}):Keybind({Flag = "silentaim_bind"})
        silentsec:Toggle({Name = "Auto Switch Target", Flag = "silentaim_autoswitch", Side = "Left"})
        silentsec:Slider({Name = "Silent Prediction", Flag = "silentaim_prediction", Min = 0, Max = 1, Default = 0.135, Decimals = 0.00001})
        silentsec:Toggle({Name = "Visible Check", Flag = "silentaim_vischeck"})
        silentsec:List({Name = "Silent Hitpart", Flag = "silentaim_hitpart", Options = {"Head", "HumanoidRootPart"}, Default = "Head"})
        silentsec:Toggle({Name = "View Target", Flag = "view", Default = false})
        silentsec:List({Name = "Target", Flag = "starget", Options = {"Player", "Dummy"}})
    
        silentsec2:Toggle({Name = "Show FOV", Flag = "silentaim_showfov"})
        silentsec2:Slider({Name = "FOV", Flag = "silentaim_fov", Min = 0, Max = 800, Default = 100})
        silentsec2:Colorpicker({Name = "FOV Color", Flag = "silentaim_fovcolor", Default = Color3.fromRGB(255, 255, 255)})

        silentsec3:Toggle({Name = "Rapid Fire", Flag = "rapidfire", Tooltip = "ong this shit barely fucking works idk who made this"})
        silentsec3:Slider({Name = "Delay", Flag = "rapid delay", Min = 0.00001, Max = 1, Decimals = 0.000001})

        -- triggerbot
        local tbsec = subpage3:Section({Name = "Triggerbot"})
        local tbsec2 = subpage3:Section({Name = "FOV", Side = "Right"})
        tbsec:Toggle({Name = "Enabled", Flag = "triggerbot_enabled"}):Keybind({Flag = "triggerbot_bind"})
		tbsec:Toggle({Name = "Team Check", Flag = "triggerbot_teamcheck"})
		tbsec:Toggle({Name = "Visibility Check", Flag = "triggerbot_vischeck"})
		tbsec:List({Name = "Target Part", Flag = "triggerbot_part", Options = {"Head", "HumanoidRootPart", "Torso"}, Default = "Head"})
		tbsec:Slider({Name = "Hit Chance", Flag = "triggerbot_hitchance", Min = 0, Max = 100, Default = 100, Suffix = "%"})
		tbsec:Slider({Name = "Delay", Flag = "triggerbot_delay", Min = 0, Max = 1, Default = 0, Decimals = 0.001})
		tbsec2:Toggle({Name = "Show FOV", Flag = "triggerbot_showfov"})
		tbsec2:Slider({Name = "FOV", Flag = "triggerbot_fov", Min = 0, Max = 800, Default = 100})
		tbsec2:Colorpicker({Name = "FOV Color", Flag = "triggerbot_fovcolor", Default = Color3.fromRGB(255, 255, 255)})
    end


    do -- visuals
        local subpage1 = Pages["Visuals"]:Weapon({})
        local subpage2 = Pages["Visuals"]:Weapon({Icon = "rbxassetid://16997762295"})

        -- esp
        local espsec1 = subpage1:Section({Name = "ESP"})
        local espsec2 = subpage1:Section({Name = "Colors", Side = "Right"})
        local espsec3 = subpage1:Section({Name = "Target", Side = "Right"})
        espsec1:Toggle({Name = "Enable ESP", Flag = "ESPEnabled"})
        espsec1:Slider({Name = "Max Distance", Flag = "ESPMaxDist", Min = 0, Max = 10000, Default = 4000})

        espsec1:Toggle({Name = "Box", Flag = "BoxESP"})
        espsec1:Toggle({Name = "Box Outline", Flag = "BoxOutline"})

        espsec1:Toggle({Name = "Name", Flag = "BoxName"})
        espsec1:Toggle({Name = "Distance", Flag = "BoxDistance"})
        espsec1:Toggle({Name = "Health Text", Flag = "BoxHealth"})
        espsec1:Toggle({Name = "Health Bar", Flag = "BoxHealthBar"})


        espsec1:Toggle({Name = "Highlight", Flag = "HighlightESP"})
        espsec1:Toggle({Name = "Highlight Always On Top", Flag = "HighlightAlwaysOnTop"})


        espsec2:Colorpicker({Name = "Box Color", Flag = "BoxColor", Side = "Right", Default = Color3.fromRGB(255,255,255)})
        espsec2:Colorpicker({Name = "Box Outline Color", Flag = "BoxOutlineColor", Side = "Right", Default = Color3.fromRGB(0,0,0)})

        espsec2:Colorpicker({Name = "Tracer Color", Flag = "TracerColor", Side = "Right", Default = Color3.fromRGB(255,255,255)})
        espsec2:Colorpicker({Name = "Tracer Outline Color", Flag = "TracerOutlineColor", Side = "Right", Default = Color3.fromRGB(0,0,0)})

        espsec2:Colorpicker({Name = "Highlight Fill Color", Flag = "HighlightFillColor", Side = "Right", Default = Color3.fromRGB(204, 153, 255)})
        espsec2:Colorpicker({Name = "Highlight Outline Color", Flag = "HighlightOutlineColor", Side = "Right", Default = Color3.fromRGB(204, 153, 255)})
        espsec2:Slider({Name = "Highlight Fill Transparency", Flag = "HighlightFillTrans", Side = "Right", Min = 0, Max = 1, Default = 0.5, Decimals = 0.01})
        espsec2:Slider({Name = "Highlight Outline Transparency", Flag = "HighlightOutlineTrans", Side = "Right", Min = 0, Max = 1, Default = 0.5, Decimals = 0.01})

        espsec3:Toggle({Name = "Highlight Target", Flag = "HighlightTarget"})
        espsec3:Colorpicker({Name = "Highlight Target Color", Flag = "HighlightTargetColor", Default = Color3.fromRGB(204, 153, 255)})
        espsec3:Colorpicker({Name = "Highlight Target Outline Color", Flag = "HighlightTargetOutlineColor", Default = Color3.fromRGB(204, 153, 255)})
        espsec3:Toggle({Name = "Flashing Highlight", Flag = "Flash"})



        -- world visuals
        local worldsec = subpage2:Section({Name = "World"})
        worldsec:Toggle({Name = "Master Switch", Flag = "Master Switch", Callback = function()
            for i,v in pairs(Lighting_Save) do 
                Lighting[i] = v 
            end 
        end})
        worldsec:Toggle({Name = "Clock Time", Flag = "Clock Time Enabled"})
        worldsec:Slider({Name = "Clock Time", Flag = 'Clock Time', Min = 0, Max = 24, Default = 12, Decimals = 0.1})
        worldsec:Toggle({Name = "Color Shift Bottom", Flag = "Color Shift Bottom"}):Colorpicker({Default = Color3.fromRGB(255, 255, 255), Flag = "Color Shift Bottom Color"});
        worldsec:Toggle({Name = "Ambient", Flag = "Ambient"}):Colorpicker({Default = Color3.fromRGB(255, 255, 255), Flag = "Ambience Color"});
        worldsec:Toggle({Name = "Outdoor Ambience", Flag = "Outdoor Ambience"}):Colorpicker({Default = Color3.fromRGB(255, 255, 255), Flag = "Outdoor Ambience color"});
        worldsec:Toggle({Name = "Brightness", Flag = "Brightness Enabled"})
        worldsec:Slider({Name = "Brightness", Flag = 'Brightness', Min = 0, Max = 20, Default = 3, Decimals = 1})
        worldsec:Toggle({Name = "Color Shift Top", Flag = "Color Shift Top"}):Colorpicker({Default = Color3.fromRGB(255, 255, 255), Flag = "Color Shift Top Color"});
        worldsec:Toggle({Name = "Fog", Flag = "Fog"}):Colorpicker({Default = Color3.fromRGB(255, 255, 255), Flag = "Fog Color"});
    end


    do -- misc
        local sec = Pages["Misc"]:Section({Name = "Misc"})
        sec:Toggle({Name = "No Slow", Flag = "No Slow"})
        sec:Toggle({Name = "No Jump Cooldown", Flag = "No Jump Cooldown"})
        sec:Toggle({Name = "Advertise lol", Flag = "ad"})
        sec:Toggle({Name = "CFrame Speed", Flag = "cfspd"}):Keybind({Flag = "spdbind"})
        sec:Slider({Name = "CFrame Speed", Flag = "speed", Min = 0, Max = 10, Default = 3, Decimals = 0.1})
    end
    ...
    do -- players
        ...
        local selected = nil
        local pl = page:PlayerList({Callback = function(player)
            selected = player
        end})
        local flags = Library.Flags
        local sec = page:Section({Name = "Testing"})
        sec:Button({Name = "Print Current", Callback = function()
            if selected then
                print(selected.Name)
            else
    ...
    do
        local Config = Pages["Settings"]:Section({Name = "Config", LeftTitle = "Config", RightTitle = "Lua Addons"}) do
            local lua = Pages["Settings"]:Section({Name = "Lua", Side = "Right", Zindex = 2})
            local CFGList = Config:List({Name = "Config list", Flag = "SettingConfigurationList", Options = {}})
            local LUAList = lua:List({Name = "Lua Addons", Flag = "LuaAddonList", Options = {}, Side = "Right"})
            local loadedluas = {}
            local abc = false
            local flags = Library.Flags
            Config:Textbox({Flag = "SettingsConfigurationName", Placeholder = "Config name"})
    
            if not isfolder("vanity_club") then 	
                makefolder("vanity_club")
            end 
            if not isfolder("vanity_club/Configs") then 
                makefolder("vanity_club/Configs")
            end 

            if not isfolder("vanity_club/LuaAddons") then
                makefolder("vanity_club/LuaAddons")
            end
    
            local function UpdateConfigList()
                local files = listfiles("vanity_club/Configs")
                local configs = {}
                
                for _, file in pairs(files) do
                    if file:sub(-4) == '.cfg' then
                        local name = string.gsub(string.gsub(file, "vanity_club/Configs\\", ""), ".cfg", "")
                        table.insert(configs, name)
                    end
                end
                
                CFGList:Refresh(configs)
            end

            local function UpdateLuaList()
                local files = listfiles("vanity_club/LuaAddons")
                local luas = {}
                for _, file in pairs(files) do
                    if file:sub(-4) == '.lua' then
                        local name = string.gsub(string.gsub(file, "vanity_club/LuaAddons\\", ""), ".lua", "")
                        table.insert(luas, name)
                    end
                end
                LUAList:Refresh(luas)
            end
    
            Config:Button({Name = "Create", Callback = function()
                local name = flags["SettingsConfigurationName"]
                if name and name ~= "" then
                    local config = Library:GetConfig()
                    writefile("vanity_club/Configs/" .. name .. ".cfg", config)
                    UpdateConfigList()
                end
            end})
            ...
            Config:Button({Name = "Save", Callback = function()
                local name = flags["SettingConfigurationList"]
                if name then
                    local config = Library:GetConfig()
                    writefile("vanity_club/Configs/" .. name .. ".cfg", config)
                end
            ...
            Config:Button({Name = "Load", Callback = function()
                local name = flags["SettingConfigurationList"]
                if name and isfile("vanity_club/Configs/" .. name .. ".cfg") then
                    local config = readfile("vanity_club/Configs/" .. name .. ".cfg")
            ...
            Config:Button({Name = "Delete", Callback = function()
                local name = flags["SettingConfigurationList"]
                if name then
                    if isfile("vanity_club/Configs/" .. name .. ".cfg") then
                        delfile("vanity_club/Configs/" .. name .. ".cfg")
                    end
                    UpdateConfigList()
                end
            end})
            ...
            Config:Colorpicker({
                Name = "Menu Accent", 
                Flag = "MenuAccent", 
                Default = Color3.fromRGB(204, 153, 255), 
            ...
            lua:Button({Name = "Load Lua", Side = "Right", Callback = function()
                local name = flags["LuaAddonList"]
                name = name:gsub("%.lua$", "")
                name = name:match("[^/\\]+$") or name
                
                if name and isfile("vanity_club/LuaAddons/" .. name .. ".lua") then
                    if loadedluas[name] and loadedluas[name]._unload then
                        pcall(loadedluas[name]._unload)
                        loadedluas[name] = nil
                    end
                    
                    local src = readfile("vanity_club/LuaAddons/" .. name .. ".lua")
                    local fn, err = loadstring(src, name)
                    
                    if fn then
                        local ok, addon = pcall(fn)
                        if ok and type(addon) == "table" and type(addon.Init) == "function" then
                            pcall(addon.Init, Library, Window, Pages)
                            loadedluas[name] = addon
                        else
                            warn("lua addon did not return properly (missing init function)")
                        end
                    else
                        warn("lua addon compile error: " .. tostring(err))
                    end
                end
            end})
            
            lua:Button({Name = "Unload Lua", Side = "Right", Callback = function()
                local name = flags["LuaAddonList"]
                if name and loadedluas[name] and loadedluas[name]._unload then
                    pcall(loadedluas[name]._unload)
                    loadedluas[name] = nil
                end
            end})

            lua:Button({Name = "Refresh", Side = "Right", Callback = function()
                UpdateLuaList()
            end})

            Config:Toggle({Name = "Show Watermark", Flag = "Watermark", Callback = function(State) Watermark:SetVisible(State) end})
...
local function loadesp(Player)
    ...
    for _, f in ipairs({LeftOutline, RightOutline, TopOutline, BottomOutline}) do
        f.BackgroundColor3 = flags["BoxOutlineColor"] or Color3.new(0, 0, 0)
        f.Visible = false
        f.BorderSizePixel = 1
    end
    ...
    for _, f in ipairs({Left, Right, Top, Bottom}) do
        f.BackgroundColor3 = flags["BoxColor"] or Color3.new(1, 1, 1)
        f.Visible = false
        f.BorderSizePixel = 0
    end
    ...
    HealthBackground.BorderColor3 = flags["BoxOutlineColor"] or Color3.new(0, 0, 0)
    ...
    RunService.RenderStepped:Connect(function()
        ...
        if onScreen and flags["ESPEnabled"] and dist < flags["ESPMaxDist"] then
            ...
            if flags["BoxESP"] then
                ...
                Left.BackgroundColor3 = flags["BoxColor"] or Color3.new(1, 1, 1)
                Right.BackgroundColor3 = flags["BoxColor"] or Color3.new(1, 1, 1)
                Top.BackgroundColor3 = flags["BoxColor"] or Color3.new(1, 1, 1)
                Bottom.BackgroundColor3 = flags["BoxColor"] or Color3.new(1, 1, 1)

                LeftOutline.BackgroundColor3 = flags["BoxOutlineColor"] or Color3.new(0, 0, 0)
                RightOutline.BackgroundColor3 = flags["BoxOutlineColor"] or Color3.new(0, 0, 0)
                TopOutline.BackgroundColor3 = flags["BoxOutlineColor"] or Color3.new(0, 0, 0)
                BottomOutline.BackgroundColor3 = flags["BoxOutlineColor"] or Color3.new(0, 0, 0)
            else
                for _, f in ipairs({Left, Right, Top, Bottom, LeftOutline, RightOutline, TopOutline, BottomOutline}) do f.Visible = false end
            end
            ...
            if flags["BoxHealthBar"] then
                ...
                if humanoid then
                    ...
                    HealthBackground.BackgroundColor3 = flags["BoxOutlineColor"] or Color3.new(0, 0, 0)
                    HealthBackground.BorderColor3 = flags["BoxOutlineColor"] or Color3.new(0, 0, 0)
                end
            else
                HealthBackground.Visible = false
            ...
            if flags["HighlightESP"] then
                ...
                Hilight.OutlineColor = flags["HighlightOutlineColor"] or Color3.fromRGB(255, 0, 0)
                Hilight.FillColor = flags["HighlightFillColor"]
                Hilight.FillTransparency = flags["HighlightFillTrans"] or 0.5
                Hilight.OutlineTransparency = flags["HighlightOutlineTrans"] or 0.5
...
fucktrannies.rapid = function(tool)
    tool:Activate()
end
...
UserInputService.InputBegan:Connect(function(i)
    if i.UserInputType == Enum.UserInputType.MouseButton1 then
        local gun = fucktrannies.get_gun()
        local flags = Library.Flags
        if flags["rapidfire"] and gun and not is_firing then
            is_firing = true
            while is_firing do
                fucktrannies.rapid(gun)
                task.wait(flags["rapid delay"])
            end
        end
    end
end)
...
do -- frameworks
    ...
    function framework:highlight_target()
        ...
        self._target_highlight.FillColor = flags["HighlightTargetColor"] or Color3.fromRGB(255,0,0)
        self._target_highlight.OutlineColor = flags["HighlightTargetOutlineColor"] or Color3.fromRGB(0,0,0)
