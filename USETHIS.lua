if game.GameId == 113491250 then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/FozzyHvH/Akira/main/akirapf.lua?token=GHSAT0AAAAAACTDA7SZ6WXS24DS7OJSZWXKZTMODKA", true))()
else
	...
	local Window = DeleteMobLib:CreateWindow(HyperEscape.GUI.GUIToggleKey, "Akira.Lua");
	...
	SettingsInfoSector:CreateCoppyText("Stolen by @pharanoh");
	SettingsInfoSector:CreateCoppyText("Akira goated");
	...
	local UIStroke = Instance.new("UIStroke")UIStroke.Color = Color3.fromRGB(100,0,100) UIStroke.Parent = FOVFFrame UIStroke.Thickness = 1 UIStroke.ApplyStrokeMode = "Border"; game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Akira.lua", Text = "Successfully loaded!"});
